...
export const EMERGENCY_DURABILITY_THRESHOLD = 15;

export const DISASTER_CHAIN_MODULE_THRESHOLD = 2;
export const DISASTER_CHAIN_EVENT_PROBABILITY = 0.7;
export const BASE_EVENT_PROBABILITY = 0.4;

export const SHIP_HEALTH_GREEN_THRESHOLD = 70;
export const SHIP_HEALTH_YELLOW_THRESHOLD = 40;
